...
ActiveRecord::Schema.define(version: 20130326132509) do
  ...
  add_index "anonymous_ratings", ["ip", "article_id"], name: "index_anonymous_ratings_on_ip_and_article_id", unique: true, using: :btree
  ...
  add_index "article_references", ["source", "referer"], name: "index_article_references_on_source_and_referer", unique: true, using: :btree
  ...
  add_index "articles", ["created_at", "group_id", "status"], name: "created_at", using: :btree
  add_index "articles", ["created_at"], name: "index_articles_on_created_at", using: :btree
  add_index "articles", ["group_id", "status", "alt_score"], name: "index_articles1", using: :btree
  add_index "articles", ["group_id", "status", "published_at", "score"], name: "index_articles2", using: :btree
  add_index "articles", ["group_id", "status", "updated_at"], name: "index_articles3", using: :btree
  add_index "articles", ["group_id", "status"], name: "index_articles4", using: :btree
  add_index "articles", ["status", "group_id"], name: "status", using: :btree
  add_index "articles", ["status"], name: "index_articles_on_id_and_status", using: :btree
  ...
  add_index "comment_ratings", ["user_id", "comment_id", "score"], name: "full_idx", using: :btree
  add_index "comment_ratings", ["user_id", "comment_id"], name: "index_comment", unique: true, using: :btree
  ...
  add_index "comments", ["article_id", "floor"], name: "index_comments_on_article_id_and_floor", unique: true, using: :btree
  add_index "comments", ["article_id", "score"], name: "index_comments_on_article_id_and_score", using: :btree
  add_index "comments", ["article_id", "status"], name: "article_id", using: :btree
  ...
  add_index "favorites", ["user_id", "favorable_id", "favorable_type"], name: "favorable_id", unique: true, using: :btree
  ...
  add_index "groups", ["alias"], name: "index_groups_on_alias", using: :btree
  add_index "groups", ["domain"], name: "index_groups_on_domain", using: :btree
  ...
  add_index "metadatas", ["article_id", "key"], name: "index_metadatas_on_article_id_and_key", unique: true, using: :btree
  ...
  add_index "notifications", ["user_id", "key"], name: "user_id", unique: true, using: :btree
  ...
  add_index "pages", ["group_id", "parent_id"], name: "index_pages_on_group_id_and_parent_id", using: :btree
  ...
  add_index "posts", ["parent_id", "reshare"], name: "index_posts_on_parent_id_and_reshare", using: :btree
  ...
  add_index "ratings", ["article_id", "user_id"], name: "pk_ratings", unique: true, using: :btree
  ...
  add_index "taggings", ["tag_id", "taggable_id", "taggable_type"], name: "tag_target", unique: true, using: :btree
  ...
  add_index "tags", ["name"], name: "id", using: :btree
  ...
  add_index "tickets", ["article_id"], name: "fk_article_id", using: :btree
  ...
  add_index "users", ["activation_code"], name: "activation_code", using: :btree
  ...
  add_index "users_roles", ["role_id", "user_id"], name: "index_roles_users_on_role_id_and_user_id", unique: true, using: :btree
  ...
  add_index "weights", ["user_id"], name: "index_weights_on_user_id", unique: true, using: :btree
